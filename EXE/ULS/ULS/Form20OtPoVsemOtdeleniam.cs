...
namespace ULS
{
    public partial class Form20OtPoVsemOtdeleniam : Form
    {
        Object Range;
        Excel._Worksheet workSheet;
        Form1 frm1;
        public Form20OtPoVsemOtdeleniam(Form1 f)
        {
            InitializeComponent();
            frm1 = f;
        }
        ...
        private void Form20OtPoVsemOtdeleniam_Load(object sender, EventArgs e)
        {
